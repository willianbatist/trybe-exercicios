...
let mostraTextosUl = document.querySelector("ul");
function clickTest(event) {
    for (let index = 0; index < mostraTextosUl.lenght; index += 1) {
        let sum;
        event.target
    }

}
mostraTextosUl.addEventListener('click', clickTest)
...
function linkMyWebpage() {
    createTagA = location.assign("https://willianbatist.github.io/");
}
myWebpage.addEventListener('dblclick', linkMyWebpage);
